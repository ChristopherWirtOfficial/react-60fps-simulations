...
import { BenchedDudes, TotalDudesAvailable } from 'TileMiner/Enemies/Dudes/TileEnemyDudesAtoms';
...
const StoreTile: FC = () => {
  ...
  return (
    <Box bg='slategray' border='1px solid white' { ...storeTileStyles } fontSize='xs'>
      <Flex flexDir='column' py='0.25rem' w='100%' gap={ 2 }>
        <Text fontWeight='semibold' textAlign='center'>
          Upgrade Store
        </Text>
        <Flex px={ 2 } alignItems='center' justifyContent='space-between' w='100%' gap={ 2 }>
